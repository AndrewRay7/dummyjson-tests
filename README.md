...
Коллекция содержит 10 методов и 20 тестов (по 2 в каждом методе) для проверок авторизации пользователй и управления корзинами:
...
- Запускается в PwerSchell или в терминале VScode  
